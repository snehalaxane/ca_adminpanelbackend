...
router.put('/', async (req, res) => {
  try {
    ...
    if (!settings) {
      ...
      if (typeof req.body.pageTitle !== 'undefined') settings.pageTitle = req.body.pageTitle;
      if (typeof req.body.pageSubtitle !== 'undefined') settings.pageSubtitle = req.body.pageSubtitle;
