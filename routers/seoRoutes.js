...
const SEOConfig = require('../model/SEOConfig');
...
router.get('/', async (req, res) => {
    ...
    { 
        pageName: 'Home',
        urlSlug: '/',
        metaTitle: 'Home - Raju & Prasad',
        metaDescription: 'Leading CA firm in India',
        keywords: ['CA', 'Taxation', 'Audit']
    },
    { 
        pageName: 'About',
        urlSlug: '/about',
        metaTitle: 'About Us - Raju & Prasad',
        metaDescription: '46+ years of excellence',
        keywords: ['About us', 'CA firm history']
    },
    { 
        pageName: 'Services',
        urlSlug: '/services',
        metaTitle: 'Our Services - Raju & Prasad',
        metaDescription: 'Taxation, Audit, GST',
        keywords: ['Taxation services', 'Audit services']
    },
    { 
        pageName: 'Contact',
        urlSlug: '/contact',
        metaTitle: 'Contact Us - Raju & Prasad',
